...
def main():
    ...
    # ================================================================
    # GRÁFICA 6: Ranking de Programas por Cumplimiento (versión barras)
    # ================================================================
    with st.expander(
        "📊 Gráfica 6: Ranking de Programas por Cumplimiento", expanded=False
    ):
        mostrar_leyenda_grafica(
            "Ranking de Programas por Cumplimiento",
            "¿Qué programas tienen mayor porcentaje de cumplimiento en cada métrica?",
        ...
        if "area" in df_filtrado.columns and metricas_disp:
            ...
            if not df_area.empty:
                ...
                st.plotly_chart(fig_bar_h, use_container_width=True, key="ranking_6")
